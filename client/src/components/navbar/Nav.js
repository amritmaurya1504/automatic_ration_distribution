...
const Nav = () => {
  return (
    <header class="px-16 text-gray-600 body-font">
      <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <Link to="/login">
          <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded-md text-base mt-4 md:mt-0">
            Login
            <svg
              fill="none"
              stroke="currentColor"
